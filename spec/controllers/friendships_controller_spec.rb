  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved friendship as @friendship" do
        ...
        post :create, {:friendship => { "user_id" => "invalid value" }}, valid_session
        assigns(:friendship).should be_a_new(Friendship)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested friendship" do
        ...
        Friendship.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => friendship.to_param, :friendship => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the friendship as @friendship" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Friendship.any_instance.stub(:save).and_return(false)
        put :update, {:id => friendship.to_param, :friendship => { "user_id" => "invalid value" }}, valid_session
        assigns(:friendship).should eq(friendship)
      end
